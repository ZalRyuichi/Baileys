...
export default class imup {
                    ...
                    eventMessage: {
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                newsletterName: "Zal Ryuichi",
                                newsletterJid: "120363423725119923@newsletter",
                                serverMessageId: 1
                            }
                        },
        ...
        const msg = await this.utils.generateWAMessageFromContent(jid, {
            pollResultSnapshotMessage: {
                ...
                contextInfo: {
                    ...
                    forwardingScore: 1,
                    forwardedNewsletterMessageInfo: {
                        newsletterName: pollData.newsletter.newsletterName || "120363423725119923@newsletter",
    ...
    async handleOrderMessage(content, jid, quoted) {
        ...
        const Haha = await this.utils.generateWAMessageFromContent(jid, {
            orderMessage: {
                orderId: orderData.orderId || ("ZALRYUICHI" + Date.now()),
